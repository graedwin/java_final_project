...
<div class="container-fluid">
        <div class="row justify-content-md-center">
                ...
                <form:form action="/rewards/${reward.id}/edit" method="post" modelAttribute="editReward" enctype="multipart/form-data">
                    <div class="form-group">
                            <form:label path="points" >Points</form:label>
                            <form:input type="number" path="points" class="form-control" id="points" value="${reward.points}"/>
                            <form:errors path="points"/>
                    </div>
                    <div class="form-group">
                            <form:label path="description">Description</form:label>
                            <form:input type="text" path="description" class="form-control" id="description" value="${reward.description}"/>
